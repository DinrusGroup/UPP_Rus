...
struct DmcBuilder : CppBuilder 
{
public:
typedef DmcBuilder CLASSNAME;
//static const String compiler = "dmd";
//static const String linker = "wlink";
void AddFlags(Index<String>& cfg);
bool BuildPackage(const String& package, Vector<String>& linkfile, String& linkoptions, const Vector<String>& all_uses, const Vector<String>& all_libraries, int opt);
bool Link(const Vector<String>& linkfile, const String& linkoptions, bool createmap);
bool Preprocess(const String& package, const String& file, const String& target, bool asmout);
String IncludesDefinesTargetTime(const String& package, const Package& pkg);
String CompilerName(bool isCpp) const;
String LinkerName() const;
String CmdLine(const String& package, const Package& pkg);
};
#endif
